                      ...
                      <tr>
                        <td style="background-color: #F9F6F0; padding: 20px 40px; text-align: center; border-top: 1px solid #EBE5D8;">
                          ...
                          <p style="font-size: 11px; color: #A0AAA5; margin: 0;">
                            You received this email because you subscribed on <a href="https://pantryandpan.com" style="color: #D48C70; text-decoration: none;">pantryandpan.com</a>. &middot; <a href="{{{ resend.unsubscribe }}}" style="color: #A0AAA5; text-decoration: underline;">Unsubscribe</a>
                          </p>
                        </td>
                      </tr>
