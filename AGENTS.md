...
- Standard Operating Procedures (SOPs) written in Markdown, living in `directives/` or `guidelines/` (e.g. `directives/newsletter_sop.md`, `directives/content_production_plan.md`, `directives/domain_email_sop.md`).
