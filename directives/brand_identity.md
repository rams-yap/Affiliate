...
### Color Palette
- `--bg-primary`: `#F9F6F0` (Warm Oat Cream)
- `--text-main`: `#2C3531` (Deep Slate Charcoal)
- `--accent-sage`: `#8A9A86` (Non-Toxic Sage Green)
- `--accent-terracotta`: `#D48C70` (Ceramic Spice / Terracotta)
- `--accent-gold`: `#C5A059` (Brushed Brass Hardware)
...
## Logo Concept
- **Option 1 Combination Mark**: A sleek, flat geometric icon merging a ceramic pan silhouette with an aesthetic pantry jar/arch contour.
- **Logo Asset Location**: `guidelines/pantry_and_pan_visuals/` or `.tmp/pantry_and_pan_logo.jpg`
